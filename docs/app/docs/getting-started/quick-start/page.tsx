...
function App() {
  return (
    <div>
      ...
      <h2>3. Customize</h2>
      <pre className="not-prose code-block">
        <code>{`<Home size={32} color="blue" strokeWidth={0.5} className="my-icon" title="Home" />
      ...
      <div className="not-prose overflow-x-auto">
        <table className="w-full text-[13px] border-collapse">
          ...
          <tbody className="text-surface-500 dark:text-surface-400">
            ...
            <tr className="border-b border-surface-100 dark:border-surface-800/50"><td className="py-2.5 font-mono text-[12px]">strokeWidth</td><td className="py-2.5">number</td><td className="py-2.5">0.5</td></tr>
