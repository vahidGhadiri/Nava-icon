      ...
      <div className="not-prose overflow-x-auto">
        <table className="w-full text-[13px] border-collapse">
          ...
          <tbody className="text-surface-500 dark:text-surface-400">
            ...
            <tr className="border-b border-surface-100 dark:border-surface-800/50"><td className="py-2.5 font-mono text-[12px]">strokeWidth</td><td className="py-2.5">number</td><td className="py-2.5">1</td><td className="py-2.5">SVG stroke width</td></tr>
