  ...
  return (
    <article className="prose dark:prose-invert max-w-none">
      ...
      <pre className="not-prose code-block">
        <code>{`import { Home } from '@whydrf/nava-icon-react'
<Home size={24} color="currentColor" />`}</code>
      </pre>
      <h2>TypeScript</h2>
      <p>
        Use the <code>IconName</code> union type for type-safe dynamic lookups:
      </p>
      <pre className="not-prose code-block">
        <code>{`import type { IconName } from '@whydrf/nava-icon-react'
